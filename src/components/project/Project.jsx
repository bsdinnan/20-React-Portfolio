export default function Project({projData: {img, imgAlt, title, text, github, deployment}}) {
    return (
        <div className="card d-inline-flex m-2 shadow-lg text-bg-dark col-sm-12 col-lg-5">
            ...
            <div className="card-body d-flex flex-column align-items-center p-2">
                ...
                <a href={github} className="btn btn-primary m-2">Github</a>
                {deployment?<a href={deployment} className="btn btn-primary m-2">Deployment</a>: null}
            </div>
        </div>
    )
}